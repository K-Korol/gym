...
<form:form method="POST" action="${pageContext.request.contextPath}/addTrainer" modelAttribute="trainer">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="" method="post" class="">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <form:label path="firstName"><input type="text" name="firstName" placeholder="First Name" class="form-control"></form:label>
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <form:label path="lastName"> <input type="text" name="lastName" placeholder="Last Name" class="form-control"></form:label>
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <form:label path="mail"> <input type="email" name="mail" placeholder="Email" class="form-control"></form:label>
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <form:label path="password"><input type="password" name="password" placeholder="Password" class="form-control"></form:label>
