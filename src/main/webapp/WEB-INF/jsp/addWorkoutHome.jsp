...
<form:form method="POST" action="${pageContext.request.contextPath}/addWorkout" modelAttribute="workout">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body card-block">
                                                <form action="" method="post" class="">
                                                    <%--<div class="form-group">
                                                        <div class="input-group">
                                                            <form:label path="date"><input type="datetime-local" name="date" placeholder="Date" class="form-control"></form:label>
                                                            <form:input path="date"/>
                                                        </div>
                                                    </div>--%>
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <form:label path="date"><input type="text" name="date" placeholder="Date" class="form-control"></form:label>
                                                                <form:input path="date"/>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <form:label path="roomId"><input type="text" name="roomId" placeholder="Room ID" class="form-control"></form:label>
                                                        ...
                                                        <div class="row form-group">
                                                            <div class="col col-md-3">
                                                                <label for="selectLg" class=" form-control-label">Workout Type</label>
                                                            </div>
                                                            <div class="col-12 col-md-9">
                                                                <form:label path="workoutType"><select name="workoutType" id="workoutType" class="form-control-lg form-control">
                                                                    <option value="0">Please select workout Type</option>
                                                                        <option value="ABS">ABS</option>
                                                                        <option value="BASIC TRAINING CIRCUIT">BASIC TRAINING CIRCUIT</option>
                                                                        <option value="BASIC TRAINING CIRCUIT">BODYPUMP</option>
                                                        ...
                                                        <div class="col-12 col-md-9">
                                                            <select name="selectLg" id="selectLg" class="form-control-lg form-control">
                                                                ...
                                                                <c:forEach  items="${rooms}" var="rooms">
                                                                    <option value="${users.roomId}">${users.roomType}</option>
                                                                </c:forEach>
                                                            </select>
                                                        </div>--%>
